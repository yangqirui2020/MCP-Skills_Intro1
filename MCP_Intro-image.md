...
* 安装成功以后：
![arxiv-mcp-server ](arxiv_mcp.png)
* 使用效果（在ArXiV上下载5篇语义分割相关的论文）
![下载 Arxiv 论文示例](下载arxiv论文.png)
* 下载以后的汇总：
![完成下载 Arxiv 论文示例](完成下载arxiv论文.png)
* 本地打开下载的论文
![本地打开下载的论文](本地打开下载的论文.png)
## 2 利用智能体技能完善提示词
---
...
![promptlookuo](skills_promptlookup.png)
**项目概述**
